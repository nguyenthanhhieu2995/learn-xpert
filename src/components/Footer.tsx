...
const COMPANY_INFO = ["About Us", "Careers", "Blog", "Contact Us"];
const FEATURES_INFO = ["Business Marketing", "User Analytic", "Live Chat", "Unlimited Support"];
          ...
          <div className="mx-auto grid grid-cols-2 gap-8 sm:gap-6  ">
            <div>
              ...
              <ul className="text-gray-500  font-medium">
                {COMPANY_INFO.map((info) => FooterItem({ text : info, key : info}))}
              </ul>
            </div>
            <div>
              <h2 className="mb-6 text-sm font-bold text-gray-900 uppercase ">
              ...
              <ul className="text-gray-500  font-medium">
                {FEATURES_INFO.map((info) => FooterItem({ text : info, key : info }))}
              </ul>
            </div>
          </div>
        </div>
